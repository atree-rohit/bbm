...
<script type="text/javascript">
	...
	$(document).ready(function () {
		var table = $("#species_table").DataTable({
			...
			"scrollX": false,
			"fixedHeader": true,
			"lengthMenu": [10, 100,250],
			"order": [[ 3, "asc" ]],
			"columns": [
			{"title": "ID", "data": "id"},
			{"title": "Participant Name", "data": "name"},
			{"title": "Sl No", "data": "affilation"},
			{"title": "Common name", "data": "phone"},
			{"title": "Species", "data": "email"},
			{"title": "Count", "data": "team_members"},
			{"title": "Remarks", "data": "photo_link"},
